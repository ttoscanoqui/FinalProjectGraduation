...
CannyData = new Canny((Bitmap)pictureBox1.Image, TH, TL, MaskSize, Sigma);      //selección de imagen a ser procesada
pictureBox2.Image = CannyData.DisplayImage(CannyData.GNH);                      //mostrar imagen en el espacio del picturebox2
